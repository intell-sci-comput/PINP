...
class Encoder(nn.Module):
    def __init__(self, n_channels = 1, base_c = 64, time = 4, out_channels = 1):
        ...
        self.inc = DoubleConv(self.n_channels,self.base_c) # n_channels = 1 灰度图
        ...
        self.fin = DoubleConv(self.base_c, out_channels)
...
class FlowNet(nn.Module):
    def __init__(self,configs):
        ...
        self.C1 = Encoder(5,configs['base_c'],4,1)
        
        self.V1 = Encoder(5,configs['base_c'],4,2)
        
        self.P1 = Encoder(5,configs['base_c'],4,1)
        ...
        self.fix = Encoder(1,configs['base_c'],5,1)
